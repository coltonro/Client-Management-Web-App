    ...
    if (editingPastSurvey) {
      ...
      fetch(`${fetchUrl}/gatherReportData`, {
        ...
        .then(data => {
          ...
          // the following is a work-around for Mantine's TimeInput component, which does not convert date objects to local time/time zone correctly when passed a date object. This code preemptively adjusts the times so they actually display correctly to the user.
          // dbStationTimeBegan is passed down to StationForm.jsx where it's values are actually utilized.
